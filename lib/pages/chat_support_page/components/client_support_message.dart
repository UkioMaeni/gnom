...
class ClientSupportMessage extends StatefulWidget {
  final Message message;
  const ClientSupportMessage({super.key,required this.message});

  @override
  State<ClientSupportMessage> createState() => _ClientSupportMessageState();
}

class _ClientSupportMessageState extends State<ClientSupportMessage> {
  @override
